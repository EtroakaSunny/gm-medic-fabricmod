...
public class GMMedicMenuScreen extends AbstractGMMedicScreen {
    ...
    protected void initWidgets() {
        ...
        this.addRenderableWidget(
                Button.builder(Component.literal("🚑 HUD-Einstellungen"), b -> this.minecraft.setScreen(new HudSettingsScreen(this)))
        ...
        this.addRenderableWidget(
                Button.builder(Component.literal("🚗 Fahrzeug-Automatik"), b -> this.minecraft.setScreen(new VehicleSettingsScreen(this)))
                        .bounds(x, y, BUTTON_WIDTH, BUTTON_HEIGHT)
                        .build()
        );
        y += ROW_SPACING;
        ...
        this.addRenderableWidget(
                Button.builder(Component.literal("🔬 Mikroskop-Diagnose"), b -> this.minecraft.setScreen(new MicroscopeSettingsScreen(this)))
                        .bounds(x, y, BUTTON_WIDTH, BUTTON_HEIGHT)
                        .build()
        );
        y += ROW_SPACING;
        ...
        this.addRenderableWidget(
                Button.builder(Component.literal("📡 API-Verwaltung"), b -> this.minecraft.setScreen(new ApiSettingsScreen(this)))
                        .bounds(x, y, BUTTON_WIDTH, BUTTON_HEIGHT)
                        .build()
        );
        y += ROW_SPACING + 10;
        ...
        this.addRenderableWidget(
                Button.builder(Component.literal("Antworttext bearbeiten"), b -> this.minecraft.setScreen(new ReviveReplyTextScreen(this)))
                        .bounds(x, y, BUTTON_WIDTH, BUTTON_HEIGHT)
                        .build()
        );
        y += ROW_SPACING + 10;
