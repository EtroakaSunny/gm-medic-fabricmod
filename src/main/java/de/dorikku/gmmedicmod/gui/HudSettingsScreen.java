...
public class HudSettingsScreen extends AbstractGMMedicScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(
                CyclingButtonWidget.onOffBuilder(cfg.isBloodDisplayEnabled())
                        .build(x, y, BUTTON_WIDTH, BUTTON_HEIGHT, Text.literal("Blutspende-Anzeige"),
                                (btn, value) -> HudConfig.getInstance().setBloodDisplayEnabled(value))
        );
        y += ROW_SPACING;

        this.addDrawableChild(
                CyclingButtonWidget.onOffBuilder(cfg.isBloodDrawMessageEnabled())
                        .build(x, y, BUTTON_WIDTH, BUTTON_HEIGHT, Text.literal("Blutspende-Meldung"),
        ...
        this.addDrawableChild(
                CyclingButtonWidget.onOffBuilder(cfg.isAlarmBannerEnabled())
                        .build(x, y, BUTTON_WIDTH, BUTTON_HEIGHT, Text.literal("Alarm-Banner"),
        ...
        this.addDrawableChild(
                ButtonWidget.builder(Text.literal("📍 HUD-Position anpassen"), b -> this.client.setScreen(new HudPositionScreen(this)))
