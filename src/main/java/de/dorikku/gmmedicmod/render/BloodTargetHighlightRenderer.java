...
public final class BloodTargetHighlightRenderer {
    ...
    private static void drawBox(WorldRenderContext ctx, MatrixStack ms, AbstractClientPlayerEntity target,
        ...
        // MC 1.21.10's VertexRendering.drawOutline has no line-width parameter; the
        // LINE_WIDTH constant is kept for a future upgrade, matching CallTargetHighlightRenderer.
